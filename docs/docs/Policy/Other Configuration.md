...
The `body_collection_rate` field is a floating point ratio between 0.0 and 1.0 denoting how often responses are to be recorded in their entirety __without redaction__. Defaults to 0.0. Responses are not able to be retrieved or analyzed at this time, pending implementation.
